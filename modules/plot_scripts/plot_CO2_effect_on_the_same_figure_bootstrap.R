plot_CO2_effect_on_the_same_figure_bootstrap <- function(budgetDF,
                                                         concDF,
                                                         poolDF,
                                                         fluxDF,
                                                         deltaDF,
    ...
    colnames(concDF)[colnames(concDF) == "conc.terms"] ="terms"
    ...
    p41 <- ggplot(plotDF21) +  
        ...
        geom_segment(aes(y=terms, x=diff_ci_low_95, 
                         yend=terms, xend=diff_ci_high_95, color=collab), alpha=0.2,
                     size=6)+
        geom_segment(aes(y=terms, x=diff_ci_low_85, 
                         yend=terms, xend=diff_ci_high_85, color=collab), alpha=0.2,
                     size=6)+
        geom_segment(aes(y=terms, x=diff_ci_low_75, 
                         yend=terms, xend=diff_ci_high_75, color=collab), alpha=0.6,
                     size=6)+
        #geom_errorbarh(aes(y=terms, xmin=diff_ci_low_95, 
        #                  xmax=diff_ci_high_95), col="black", height=0.1)+
    ...
    pdf("output/si_figures/ed_figure7_bootstrap.pdf", 
        width=10, height=6)
    ...
    pdf("output/si_figures/ed_figure8_bootstrap.pdf", 
        width=10, height=10)
    ...
    pdf("output/figures/figure4_bootstrap.pdf", 
        width=12, height=4)
