plot_CO2_effect_on_the_same_figure <- function(budgetDF,
    ...
    p41 <- ggplot(plotDF21) +  
        ...
        geom_point(aes(y=terms, #fill=collab, 
                       x=diff), color="black", fill="grey",
    ...
    p43 <- ggplot(plotDF23) +  
        ...
        scale_y_discrete(limits=c("Occluded P Conc 0-10cm",
                         ...
                         labels=c("Exchangeable Pi Conc 0-10cm" = expression("Exchangeable " * P[i]),
                                  ...
                                  "Occluded P Conc 0-10cm" = expression("Residual P")))+
        scale_fill_manual(name="",
                          labels=c("pos"="Positive",
                                   "neg"="Negative",
                                   "neut"="Zero"),
    ...
    p53 <- ggplot(plotDF33) +  
        ...
        scale_y_discrete(limits=c("Occluded P Pool",
                         ...
                         labels=c("Exchangeable Pi Pool" = expression("Exchangeable " * P[i]),
                                  ...
                                  "Occluded P Pool" = expression("Residual P")))+
        scale_fill_manual(name="",
                          labels=c("pos"="Positive",
                                   "neg"="Negative",
                                   "neut"="Zero"),
    ...
    pdf("output/figures/figure4.pdf", 
        width=12, height=4)
