make_litter_c_flux <- function(c_frac){
    ...
    #### read in data
    f16 <- read.csv("data/raw/FACE_P0017_RA_Litter_20160101-20161212-L1-V2.csv")
    f15 <- read.csv("data/raw/FACE_P0017_RA_Litter_20150101-20151217-L1-V2.csv")
    f14 <- read.csv("data/raw/FACE_P0017_RA_Litter_20140101-20141216-L1-V2.csv")
    f13 <- read.csv("data/raw/FACE_P0017_RA_Litter_20121001-20131231-L1-V2.csv")
    ...
    write.csv(litter_a, "data/processed/litter_c_production_flux.csv", row.names=F)
